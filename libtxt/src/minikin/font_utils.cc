...
void analyzeAxes(const uint8_t* fvar_data,
  ...
  constexpr size_t kMajorVersionOffset = 0;
  constexpr size_t kMinorVersionOffset = 2;
  constexpr size_t kOffsetToAxesArrayOffset = 4;
  constexpr size_t kAxisCountOffset = 8;
  constexpr size_t kAxisSizeOffset = 10;
...
bool analyzeStyle(const uint8_t* os2_data,
                  ...
                  int* weight,
                  bool* italic) {
  constexpr size_t kUsWeightClassOffset = 4;
  constexpr size_t kFsSelectionOffset = 62;
  constexpr uint16_t kItalicFlag = (1 << 0);
