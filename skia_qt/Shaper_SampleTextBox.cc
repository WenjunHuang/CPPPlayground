...
static const char gText[] =
    "When 🐉☺️❤️👮🏿👨‍👩‍👧‍👦🚵 in the Course of human events it becomes necessary for one people "
...
void DrawText(SkCanvas* canvas,
  ...
  for (int i = 9; i < 24; i += 2) {
    ...
    auto font = SkShaper::MakeFontMgrRunIterator(utf8,utf8_bytes,src_font,SkFontMgr::RefDefault(),
                                                 "Arial",SkFontStyle::Bold(),&*language);
    if (!font)
      return;

    shaper->shape(utf8,utf8_bytes,*font,*bidi,*script,*language,width - margin,&builder);
...
//    auto text_blob = SkTextBlob::MakeFromText(utf8,utf8_bytes,default_font);
