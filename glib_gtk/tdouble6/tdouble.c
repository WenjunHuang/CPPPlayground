...
static void div_by_zero_default_cb(TDouble *d) {
  g_print("\nError: division by zero.\n\n");
}

static void
t_double_set_property(GObject *object, guint property_id,
                      const GValue *value,
                      GParamSpec *pspec) {
...
t_double_class_init(TDoubleClass *class) {
  ...
  t_double_signal = g_signal_new_class_handler("div-by-zero",
  ...
  double_property = g_param_spec_double("value", "val", "Double value", -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
                                        G_PARAM_READWRITE);
